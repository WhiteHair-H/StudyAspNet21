<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BoardWrite.aspx.cs" Inherits="DotNetNote.Board.BoardWrite" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h3 class="text-center">게시판 글쓰기</h3>
    <asp:Label ID="LblTitleDes" runat="server" />
    <hr />
